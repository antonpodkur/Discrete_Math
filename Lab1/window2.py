...
class Ui_Window2(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", str(self.A)))
        self.label_3.setText(_translate("MainWindow", str(self.B)))
        self.label_4.setText(_translate("MainWindow", "B"))
        self.label_5.setText(_translate("MainWindow", str(self.C)))
        ...
        self.label_9.setText(_translate("MainWindow", "Sets-operands"))
        self.label_10.setText(_translate("MainWindow", "Sets-results"))
    ...
    def steps(self):
        ...
        if self.counter == 1:
            ...
            self.label_11.setText("-A")
            self.label_11.adjustSize()
            self.notA = self.vers_set - self.A
            self.label_12.setText(str(self.notA))
            self.label_12.adjustSize()
            self.label_8.setText("2")
            self.label_8.adjustSize()
        elif self.counter == 3:
            self.label_11.setText("-B | C")
            self.label_11.adjustSize()
            self.notBnC = self.notB | self.C
            self.label_12.setText(str(self.notBnC))
            self.label_12.adjustSize()
            self.label_8.setText("3")
            self.label_8.adjustSize()
        elif self.counter == 4:
            self.label_11.setText("-A & C")
            self.label_11.adjustSize()
            self.notAnC = self.notA & self.C
            self.label_12.setText(str(self.notAnC))
            self.label_12.adjustSize()
            self.label_8.setText("4")
            self.label_8.adjustSize()
        elif self.counter == 5:
            self.label_11.setText("A & (-B | C)")
            self.label_11.adjustSize()
            self.AnBC = self.A & self.notBnC
            self.label_12.setText(str(self.AnBC))
            self.label_12.adjustSize()
            self.label_8.setText("5")
            self.label_8.adjustSize()
        elif self.counter == 6:
            self.label_11.setText("A & (-B | C) | (-A & C)")
            self.label_11.adjustSize()
            self.D = self.AnBC | self.notAnC
            self.label_12.setText(str(self.D))
            self.label_12.adjustSize()
            self.label_8.setText("6")
            self.label_8.adjustSize()
